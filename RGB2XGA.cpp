...
//    int      xga_chan_1 = 3;
   ...
   //stdio_init_all();
    ...
    int xga_chan_0 = dma_claim_unused_channel(true);
    int xga_chan_1 = dma_claim_unused_channel(true);
    ...
    channel_config_set_dreq(&c2, DREQ_PIO1_TX2) ;                  // DREQ_PIO1_TX2 pacing (FIFO)
    ...
    pio_enable_sm_mask_in_sync(xga_pio, ((1u << smhSync) | (1u << smvSync) | (1u << smXGAPixs)));
